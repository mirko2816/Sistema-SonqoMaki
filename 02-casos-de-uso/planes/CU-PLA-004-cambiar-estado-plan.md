...
1. El especialista solicita un estado permitido: activo, en pausa o finalizado.
...
5. El sistema actualiza el estado y la representacion publica del plan.
6. Si queda en pausa o finalizado, el sistema impide nuevos envios.
