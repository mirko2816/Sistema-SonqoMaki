...
Route::get('/mi-rutina/{token}', PublicRoutineController::class)
    ->middleware([AddPublicRoutineSecurityHeaders::class, 'throttle:public-routine'])
    ->withoutMiddleware([
        ValidateCsrfToken::class,
        StartSession::class,
        ShareErrorsFromSession::class,
    ])
    ->name('public-routine.show');
