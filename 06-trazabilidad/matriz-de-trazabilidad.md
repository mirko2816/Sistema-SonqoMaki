...
| Biblioteca de ejercicios | `RF-EJE-001` a `RF-EJE-006` | `CU-EJE-001` a `CU-EJE-003` | `exercises` |
...
| Biblioteca de rutinas | `RF-RUT-008` | `CU-RUT-002` | `routine_templates`, `routine_template_exercises` |
